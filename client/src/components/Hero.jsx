...
const Hero = () => {
  ...
  return (
    ...
    className='h-screen flex flex-col items-center justify-center gap-14 bg-gradient-to-br from-light via-gray-light to-accent-light text-center'>
      ...
      transition={{ duration: 0.6, delay: 0.4 }}
       ...
       onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_12px_24px_rgba(0,0,0,0.15)] border border-borderColor/20'>
